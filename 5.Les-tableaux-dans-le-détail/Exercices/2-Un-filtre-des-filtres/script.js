...
const filteredCompanies = companies.filter(rev => rev.revenue > 500)
...
const truthyValues = values.filter(truthy => truthy);
...
const names = ["Adrien", "Paul", "Victor", "Alexandre", "Aurélie", "Antoine",'Alex'];
